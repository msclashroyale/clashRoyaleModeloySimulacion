 ...
 */
public class EstrategiaMenorCosto implements EstrategiaIA {
    ...
    private Posicion buscarPosicionValidaAleatoria(List<Posicion> zonasPermitidas, Tablero tablero, Jugador jugador) {
        ...
        java.util.Collections.shuffle(zonasPermitidas, generadorAleatorio);

        for (Posicion candidata : zonasPermitidas) {
